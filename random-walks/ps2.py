...
class StandardRobot(Robot):
    ...
    def updatePositionAndClean(self):
        ...
        #ustal position I direction robota
...
num_robot_range = range(1, 11, 1)
times1 = []
#plot1 = showPlot1('Standard and Random', num_robot_range, times1)

# 2) Write a function call to showPlot2 that generates an appropriately-labeled plot.
aspect_ratios = []
times1 = []
#plot2 = showPlot2('Floor shape', aspect_ratios, times1)
